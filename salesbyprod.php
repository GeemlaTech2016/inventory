                                        ...
                                        <div class="banner-bottom-left">
                                            ...
                                            <div class="banner-bottom-left-grids">
                                                <div class="col-md-12 banner-left-grid fullwidth-left-grid login-right wow fadeInLeft" data-wow-delay="0.4s">
                                                    <h3>Sales Report for Category</h3><p>&nbsp;</p>
                                                            ...
                                                            <thead>
                                                                <tr style="font-size:13px">
                                                                    <th><select name="product" required>
                                                                            ...
                                                                            <?php
                                                                            $qu = mysqli_query($conn, "select * from products");
                                                                            while ($rs1 = mysqli_fetch_array($qu)) {
                                                                                ?>
                                                                                <option value="<?php echo $rs1['prodid'] ?>"><?php echo $rs1['prodname'] ?></option>
                                                                                <?php
                                                                            }
                                                                            ?>
                                                                        </select></th>
                                                    ...
                                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example1">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            if (array_key_exists("find", $_POST)) {
                                                                ...
                                                                $gpp = mysqli_query($conn, "select * from productcat where prodid='$product'");
                                                                while ($rgpp = mysqli_fetch_array($gpp)) {
                                                                    $q = mysqli_query($conn, "select * from sales where prodid='$rgpp[catid]' and dot>='$_POST[sdate] 00:00:00' and dot<='$_POST[enddate] 23:59:59' order by dot asc");
                                                                    while ($rs = mysqli_fetch_array($q)) {
                                                                        $b++;
                                                                        $gp = mysqli_fetch_array(mysqli_query($conn, "select prodid from productcat where catid='$rs[prodid]'"));
