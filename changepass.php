...
$gettypes=NULL;
	...
	$gettypes=mysqli_fetch_array(mysqli_query($conn, "select * from login where userid='$user'"));	

if(isset($_POST['ok'])!=''){
	if($gettypes['password']==$_POST['oldpass']){
		if($_POST['newpass']==$_POST['conpass']){
			if(mysqli_query($conn, "update login set password='{$_POST["newpass"]}' where userid='$user'")){
			$msg='<div class="alert alert-success alert-dismissable">
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                                        Password change Successful. Please <a href="out.php">Login</a> again
            </div>';	
			...
			<div class="banner-bg"> 
					...
					<div class="banner">
						...
						<?php include("nav.php");?>
								...
								<h2><a href="">PASSWORD UPDATE</a></h2>	
									...
									<div class="banner-bottom-left">
										...
										<div class="banner-bottom-left-grids">
                                            <div class="col-md-8 banner-left-grid fullwidth-left-grid login-right wow fadeInLeft" data-wow-delay="0.4s">
												<h3>Update your Password</h3><p><?php echo $msg?></p>
