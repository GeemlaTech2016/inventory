...
<div class="container">
			...
			<div class="banner-bg"> 
					...
					<div class="banner">
						...
						<?php include("nav.php");?>
								...
								<h2><a href="">TRANSACTION HISTORY</a></h2>	
									...
									<div class="banner-bottom-left">
										...
										<div class="banner-bottom-left-grids">
                                            <div class="col-md-12 banner-left-grid fullwidth-left-grid login-right wow fadeInLeft" data-wow-delay="0.4s">
												<h3>Transaction History</h3><p>&nbsp;</p>
                   <form name="form1" method="post" action="">
		<table width="100%" class="table table-striped table-bordered table-hover">
                               <thead>
                                    <tr style="font-size:12px">
                                        <th><select name="transtype">
                                        <option>Debt</option>
                                        <option>Sale</option>
					...
					$b=0;
					$q = mysqli_query($conn,"select * from transhistory where transtype='$_POST[transtype]' and dot>='$_POST[sdate] 00:00:00' and dot<='$_POST[enddate] 23:59:59' order by dot asc");
					while($rs = mysqli_fetch_array($q)){
						$b++;
						$gc=mysqli_fetch_array(mysqli_query($conn,"select custname from customers where custid='$rs[customer]'"));
						
						$tp = $tp + $rs['tco'];
					?>            
        <tr class="" style="font-size:13px;">
                                      <td><?php echo $rs['dot']?></td>
                                        <td><?php echo $rs['transid']?></td>
  ...
  <td colspan="6"><a style="font-weight:bold; color:#903" href="javascript:printtab()">Print</a></td>
