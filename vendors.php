...
if (isset($_GET['id']) && $_GET['id'] != '') {
    $id = $_GET['id'];
    $gettypes = mysqli_fetch_array(mysqli_query($conn, "select * from vendors where vendid='{$_GET["id"]}'"));
}

if (isset($_POST['ok']) != '') {
    if ($_POST['id'] != '') {
        if (mysqli_query($conn, "update vendors set vendname='{$_POST["vendname"]}',phone='{$_POST["phone"]}',email='{$_POST["email"]}',address='{$_POST["address"]}',cperson='{$_POST["cperson"]}',btype='{$_POST["btype"]}' where vendid='{$_POST["id"]}'")) {
        ...
        $getn = mysqli_num_rows(mysqli_query($conn, "select * from vendors"));
        $g = $getn + 1;
        $vendid = "V" . $g . date('Ymd');
        if (mysqli_query($conn, "insert into vendors(vendid,vendname,phone,email,address,cperson,btype) values('$vendid','{$_POST["vendname"]}','{$_POST["phone"]}','{$_POST["email"]}','{$_POST["address"]}','{$_POST["cperson"]}','{$_POST["btype"]}')")) {
            $msg = '<div class="alert alert-success alert-dismissable">
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
...
if (mysqli_query($conn, "delete from vendors where vendid='$del'"))
                            ...
                            <div class="banner-grids">
                                ...
                                <div class="ban-top">
                                    ...
                                    <div class="col-md-12 bann-right">
                                        <h2><a href="">VENDORS/SUPPLIERS</a></h2>	
                                        ...
                                        <div class="banner-bottom-left">
                                            ...
                                            <div class="banner-bottom-left-grids">
                                                <div class="col-md-4 banner-left-grid fullwidth-left-grid login-right wow fadeInLeft" data-wow-delay="0.4s">
                                                    <h3>Add New Supplier</h3><p><?php echo $msg ?></p>
                                                    <form name="form1" method="post" action="">
                                                        <div>
                                                            <span>Vendor Name<label>*</label></span>
                                                            <input type="text" name="vendname" required value="<?php echo $gettypes['vendname'] ?>"> 
                                                        </div>
                                                        <div>
                                                            <span>Contact Person<label>*</label></span>
                                                            <input type="text" name="cperson" value="<?php echo $gettypes['cperson'] ?>"> 
                                                        </div>
                                                        <div>
                                                        ...
                                                        <div>
                                                            ...
                                                            <input type="text" name="btype" value="<?php echo $gettypes['btype'] ?>"> 
                                                        </div>

                                                        <div>
                                                            <span>Address</span>
                                                            <input type="text" name="address" value="<?php echo $gettypes['address'] ?>"> 
                                                            <input type="hidden" name="id" value="<?php echo $gettypes['vendid'] ?>"> 
                                                        </div>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            while ($rs = mysqli_fetch_array($q)) {
                                                                ...
                                                                <tr class="" style="font-size:10px;">
                                                                    ...
                                                                    <td><?php echo $rs['vendname'] ?></td>
                                                                    <td><?php echo $rs['phone'] ?></td>
                                                                    <td><?php echo $rs['email'] ?></td>
                                                                    <td><?php echo $rs['address'] ?></td>
                                                                    <td><a href="vendors.php?id=<?php echo $rs['vendid'] ?>">Edit</a>&nbsp;&nbsp;
                                                                        <a href="vendors.php?del=<?php echo $rs['vendid'] ?>">Delete</a></td>
                                                                </tr>
                                                                <?php
                                                            }
                                                            ?>        
