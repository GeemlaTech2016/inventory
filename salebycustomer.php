...
<html>
  ...
  from sales where (dot>='$_POST[sdate] 00:00:00' and dot<='$_POST[enddate] 23:59:59') and (custid !=NULL or custid != '') group by prodid,custid order by dot asc;");
                                                        ?>
                                                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example1">
                                                            <thead>
                                                                <tr style="font-size:13px;">
                                                                    <th colspan="6" style="text-align:center;">Customer Purchase Report from <?php echo $_POST['sdate'] ?> to <?php echo $_POST['enddate'] ?></th>
                                                                </tr>
                                                                <tr style="font-size:13px">
                                                                    <th>Date</th>
                                                                    <th>Product</th>
