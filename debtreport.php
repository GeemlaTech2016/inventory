...
<div class="container">
	<div class="bg-banner">
		...
		<table width="100%" class="table table-striped table-bordered table-hover">
					...
					$b=0; 
					$q = mysqli_query("select * from debtors where dot>='$_POST[sdate]' and dot<='$_POST[enddate]' order by dot asc");
					while($rs = mysqli_fetch_array($q)){
						$b++;
						$gc=mysqli_fetch_array(mysqli_query("select custname from customers where custid='$rs[receiver]'"));
					?>            
