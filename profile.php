...
$gettypes=NULL;
	...
	$gettypes=mysqli_fetch_array(mysqli_query($conn, "select * from employees where empid='$user'"));	

if(isset($_POST['ok'])!=''){

		if(mysqli_query($conn, "update employees set empname='{$_POST["empname"]}',phone='{$_POST["phone"]}',email='{$_POST["email"]}',address='{$_POST["address"]}',gender='{$_POST["gender"]}' where empid='$user'")){
									...
									<div class="banner-bottom-left">
										...
										<div class="banner-bottom-left-grids">
                                            <div class="col-md-8 banner-left-grid fullwidth-left-grid login-right wow fadeInLeft" data-wow-delay="0.4s">
												<h3>View/Update your Profile</h3><p><?php echo $msg?></p>
												<form name="form1" method="post" action="">
												<div>
													<span>Employee ID<label>*</label></span>
													<input type="text" name="empid" required value="<?php echo $gettypes['empid']?>" readonly> 
												</div>
                                                <div>
                                                ...
                                                <div>
													<span>Hire Date</span>
													<input type="text" name="hiredate" id="hiredate" value="<?php echo $gettypes['hiredate']?>" readonly> 
												</div>
                                                <div>
													<span>Address</span>
                                                ...
                                                <div>
                                                 ...
                                                 <div>
													...
													<input type="text" name="guarantor" value="<?php echo $gettypes['guarantor']?>" readonly> 
												</div>
