	...
	<div class="bg-banner">
			...
			<div class="banner-bg"> 
					...
					<div class="banner">
						...
						<?php include("nav.php");?>
								...
								<h2><a href="">DAILY EXPENSE REPORT</a></h2>	
									...
									<div class="banner-bottom-left">
										...
										<div class="banner-bottom-left-grids">
                                            <div class="col-md-12 banner-left-grid fullwidth-left-grid login-right wow fadeInLeft" data-wow-delay="0.4s">
												<h3>Daily Expense Report</h3><p>&nbsp;</p>
		...
		<table width="100%" class="table table-striped table-bordered table-hover">
                               <thead>
                                 ...
                                 <?php
								$up=0.0; $tp=0.0; $totcy=0.0; $tot=0.0;
					if(array_key_exists("find",$_POST)){
					$b=0;
					$q1 = mysqli_query($conn,"select * from expenses where dot>='$_POST[sdate] 00:00:00' and dot<='$_POST[enddate] 23:59:59' order by dot asc");
								?>
												<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example1">
                               <thead>
                                <tr style="font-size:13px;">
                                        <th colspan="6" style="text-align:center;">Daily Expense Report from <?php echo $_POST['sdate'] ?> to <?php echo $_POST['enddate'] ?></th>
                                 </tr>
                                    <tr style="font-size:10px">
                                        <th>Date</th>
                                        <th>Amount</th>
					...
					$eid = $rs1['ecode'];
					$stotal=0.0;
					$q = mysqli_query($conn,"select dot,amt,purpose,exptype,receiver,approvedby from expenses where dot>='$_POST[sdate]' and dot<='$_POST[enddate]' and exptype='$eid' order by dot desc");
