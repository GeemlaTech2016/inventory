                                            ...
                                            <div class="banner-bottom-left-grids">
                                                <div class="col-md-12 banner-left-grid fullwidth-left-grid login-right wow fadeInLeft" data-wow-delay="0.4s">
                                                    ...
                                                    if (array_key_exists("find", $_POST)) {
                                                        $b = 0;
                                                        $q = mysqli_query($conn, "select * from sales where dot>='$_POST[sdate] 00:00:00' and dot<='$_POST[enddate] 23:59:59' and status='active' order by dot asc");
                                                        ?>
                                                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example1">
                                                            <thead>
                                                                <tr style="font-size:13px;">
                                                                    <th colspan="7" style="text-align:center;">Sales Report from <?php echo date_format(date_create($_POST['sdate']), "d/m/Y") ?> to <?php echo date_format(date_create($_POST['enddate']), "d/m/Y") ?></th>
                                                                </tr>
                                                                <tr style="font-size:13px">
                                                                    <th>Date</th>
                                                                    <th>Product</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                while ($rs = mysqli_fetch_array($q)) {
                                                                    ...
                                                                    $gas = mysqli_fetch_array(mysqli_query($conn, "select * from assignproduct where product='$gp[prodid]'"));
                                                                    $gem = mysqli_fetch_array(mysqli_query($conn, "select * from employees where empid='$rs[staffid]'"));
                                                                    $up = $up + $rs['unitprice'];
                                                                    $tp = $tp + $rs['totalprice'];
                                                                    $q11 = $q11 + $rs['qty'];
                                                                    ...
                                                                    <tr class="" style="font-size:13px;">
                                                                        ...
                                                                        <td><?php echo $rs['transtype'] ?></td>
                                                                        <td><?php echo $gem['empname'] ?></td>
                                                                    </tr>
                                                                    <?php
                                                                }
                                                                if ($b > 0) {
                                                                ...
                                                                <tr class="" style="font-size:13px; font-weight:bold">
                                                                    ...
                                                                    <td colspan="3">Supervisor<br>Sign</td>
                                                                </tr>
                                                                <tr class="" style="font-size:13px; font-weight:bold">
                                                                    <td colspan="7">&nbsp;</td>
                                                                </tr>
                                                                <tr class="" style="font-size:13px; font-weight:bold">
                                                                    <td colspan="7" style="text-align:center">Managing Director<br>Sign</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        <?php
