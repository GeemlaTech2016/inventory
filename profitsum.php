	...
	<div class="bg-banner">
		...
		<table width="100%" class="table table-striped table-bordered table-hover">
					...
					$q = mysqli_query($conn,"select * from sales where dot>='$_POST[sdate] 00:00:00' and dot<='$_POST[enddate] 23:59:59' order by dot asc");
                               ...
                               <thead>
                               <tr style="font-size:13px">
                                        <th colspan="7" style="text-align:center;">Profit Summary from <?php echo $_POST['sdate']?> to <?php echo $_POST['enddate']?></th>
                                    </tr>
                                    <tr style="font-size:13px">
                                        <th>&nbsp;</th>
		...
		$p =  $p + $n;
		//$cst = $gettypes['cprice']*$gpp['cylindersize'];
		//$sale = $gettypes['sprice']*$gpp['cylindersize'];
					?>            
