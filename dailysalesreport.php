                            ...
                            <div class="banner-grids">
                                ...
                                <div class="ban-top">
                                    ...
                                    <div class="col-md-12 bann-right">
                                        <h2><a href="">DAILY SALES REPORT</a></h2>	
                                            ...
                                            <div class="banner-bottom-left-grids">
                                                <div class="col-md-12 banner-left-grid fullwidth-left-grid login-right wow fadeInLeft" data-wow-delay="0.4s">
                                                    ...
                                                    if (array_key_exists("find", $_POST)) {
                                                        $b = 0;
                                                        //$q = mysqli_query("select * from returnedgoods where dot>='$_POST[sdate] 00:00:00' and dot<='$_POST[enddate] 23:59:59' and custid = '$_POST[dealer]' order by dot asc");
                                                        $q = mysqli_query($conn, "select s.saleid, s.prodid, s.qty, s.unitprice, s.totalprice, r.qty from sales as s left outer join returnedgoods as r on s.saleid = r.saleid where r.dot>='$_POST[sdate] 00:00:00' and r.dot<='$_POST[sdate] 23:59:59' and r.custid = '$_POST[dealer]' order by r.dot asc");
                                                        $cus = mysqli_fetch_array(mysqli_query($conn, "select * from customers where custid='$_POST[dealer]'"));
                                                        ?>
                                                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example1">
                                                            <thead>
                                                                <tr style="font-size:13px;">
                                                                    <th colspan="8" style="text-align:center;">Goods Report for <?php echo $cus['custname'] ?> for <?php echo $_POST['sdate'] ?> </th>
                                                                </tr>
                                                                <tr style="font-size:13px">
                                                                    <th>Item ID</th>
                                                                    <th>Product</th> 
                                                            ...
                                                            <tbody>
                                                                ...
                                                                while ($rs1 = mysqli_fetch_array($q)) {
                                                                    ...
                                                                    <tr class="" style="font-size:13px;">
                                                                        ...
                                                                        <td><?php echo $nq ?></td>
                                                                        <td><?php echo $nq - $rs1['qty'] - $qtyleaked ?></td>
                                                                        <td><?php echo $rs1['qty'] ?></td>
                                                                        <td><?php echo $qtyleaked ?></td>
                                                                ...
                                                                <tr class="" style="font-size:13px; font-weight:bold">
                                                                    ...
                                                                    <td align="right">Original:<?php echo number_format($atp, 2) ?><br>Returns:<?php echo number_format($tp, 2) ?><br>Balance:<?php echo number_format($bal, 2) ?></td>
                                                                </tr>
                                                                <tr class="" style="font-size:13px; font-weight:bold">
                                                                    <td colspan="9">&nbsp;</td>
                                                                </tr>
                                                                ...
                                                                <tr class="" style="font-size:13px; font-weight:bold">
                                                                    <td colspan="5">Cahier<br>Sign</td>
                                                                ...
                                                                <tr class="" style="font-size:13px; font-weight:bold">
                                                                    <td colspan="9" style="text-align:center">Managing Director<br>Sign</td>
                                                                </tr>
                                                            </tbody>
                                                        </table>
                                                        <?php
