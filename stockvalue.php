			...
			<div class="banner-bg"> 
					...
					<div class="banner">
						...
						<?php include("nav.php");?>
								...
								<h2><a href="">CURRENT STOCK VALUE</a></h2>	
							...
							<div class="banner-middle">
                               ...
                               <thead>
                               <tr style="font-size:13px; color:#F00">
                                        <th colspan="2">Note: This values might not be totally accurate due to several factors</th>
                                        
                                    </tr>
                                    <tr style="font-size:13px">
                                        <th>Current Stock (Purchase) in Naira</th>
                                        <th>Current Stock (Selling Price) in Naira</th>
                                       <!-- <th>Current Stock (Selling Price Wholesale) N</th>-->
                                    </tr>
                                </thead>
                                <tbody>
					...
					$sp = 0.0;
					$spd = 0.0;
					//$q = mysqli_query("select * from productcat");
					$q = mysqli_query($conn,"select * from products");
					while($rs = mysqli_fetch_array($q)){
						$b++;
						$cp = $cp + ($rs['totqty'] * $gettypes['cprice']);
						$sp = $sp + ($rs['totqty'] * $gettypes['sprice']);
						//$spd = $spd + ($rs['instock'] * $rs['sellpricedealer']);
					}
					?>            
        <tr class="" style="font-size:13px;">
                                      <td><?php echo number_format($cp,2);?></td>
                                        <td><?php echo number_format($sp,2);?></td>
                                        <!--<td><?php //echo number_format($spd,2);?></td>-->
        </tr>
