...
<html>
                            ...
                            <div class="banner-grids">
                                ...
                                <div class="ban-top">
                                    ...
                                    <div class="col-md-12 bann-right">
                                        <h2><a href="">PRODUCT SALES SUMMARY</a></h2>	
                                                        ...
                                                        <table width="100%" class="table table-striped table-bordered table-hover">
                                                            <thead>
                                                                <tr style="font-size:11px">
                                                                    <th><select name="product" required>
                                                                            <option value="">Select One</option>
                                                                            <?php
                                                                            $qu = mysqli_query($conn, "select * from productcat");
                                                            ...
                                                            <thead>
                                                                <tr style="font-size:12px;">
                                                                    <th colspan="8" style="text-align:center;">
                                                                        Sale Report from <?php echo date_format(date_create($_POST['sdate']), "d/m/Y") ?> to <?php echo date_format(date_create($_POST['enddate']), "d/m/Y") ?></th>
                                                                </tr>
  ...
  from sales where (dot>='$_POST[sdate] 00:00:00' and dot<='$_POST[enddate] 23:59:59')
  and prodid='$_POST[product]' and status='active' group by prodid order by prodid asc;");
                                                                //$totq= $qrr['totq']; 

                                                                $q = mysqli_query($conn, "select prodid, unitprice,dot, custid, qty as 'totq', totalprice as 'totp', staffid, transtype
                                                                    from sales where (dot>='$_POST[sdate] 00:00:00' and dot<='$_POST[enddate] 23:59:59')
                                                                    and prodid='$_POST[product]' and status='active' order by dot asc;");
                                                                ...
                                                                $get_curent_stock = mysqli_fetch_array(mysqli_query($conn, "select instock from productcat where catid='$_POST[product]'"));
                                                                $current_stock = $get_curent_stock['instock'];

                                                                $get_stockhistory = mysqli_query($conn, "select addedqty from stockhistory where prodid='$_POST[product]' and dot>='$_POST[sdate]'");
                                                                while ($stockhistory = mysqli_fetch_array($get_stockhistory)) {
                                                                    $current_stock -= $stockhistory['addedqty'];
                                                                }

                                                                $date_stock = $current_stock;

                                                                $get_saleshistory = mysqli_query($conn, "select qty from sales where prodid='$_POST[product]' and dot>='$_POST[sdate]'");
                                                                while ($saleshistory = mysqli_fetch_array($get_saleshistory)) {
                                                                    $date_stock += $saleshistory['qty'];
                                                                }

                                                                ///echo $date_stock;

                                                                while ($rq1 = mysqli_fetch_array($q)) {
                                                                    $b++;
                                                                    ...
                                                                    <tr class="" style="font-size:12px;">
                                                                        ...
                                                                        <td><?php echo $date_stock ?></td>
                                                                        <td><?php echo $rq1['totq'] ?></td>
                                                                        <td><?php echo $date_stock - $rq1['totq'] ?></td>
                                                                        <td><?php echo number_format($rq1['unitprice'], 2) ?></td>
                                                                        <td><?php echo number_format($credit_amt, 2) ?></td>
