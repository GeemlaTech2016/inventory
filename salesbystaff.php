...
<html>
                            ...
                            <div class="banner-grids">
                                ...
                                <div class="ban-top">
                                    ...
                                    <div class="col-md-12 bann-right">
                                        <h2><a href="">STAFF SALES REPORT</a></h2>	
                                                        ...
                                                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example1">
                                                            <thead>
                                                                <tr style="font-size:12px;">
                                                                    <th colspan="7" style="text-align:center;"><?php echo $cname['empname'] ?> Sale Report from <?php echo date_format(date_create($_POST['sdate']), "d/m/Y") ?> to <?php echo date_format(date_create($_POST['enddate']), "d/m/Y") ?></th>
                                                                </tr>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                while ($rs = mysqli_fetch_array($qp)) {
                                                                    $qrr = mysqli_fetch_array(mysqli_query($conn, "select prodid, dot, sum(qty) as 'totq', sum(totalprice) as 'totp', staffid
  from sales where (dot>='$_POST[sdate] 00:00:00' and dot<='$_POST[enddate] 23:59:59')
  ...
  and prodid='$rs[product]' and staffid = '$rs[empid]' and status='active' order by dot asc;");
                                                                    ...
                                                                    while ($rq1 = mysqli_fetch_array($q)) {
                                                                        ...
                                                                        $gc = mysqli_fetch_array(mysqli_query($conn, "select custid,custname from customers where custid='$rq1[custid]'"));
                                                                        //$up = $up + $rs['unitprice'];
                                                                        $tp = $tp + $rq1['totp'];
                                                                        $tq = $tq + $rq1['totq'];
                                                                        $instock = $gp['instock'];
