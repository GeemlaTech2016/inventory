...
if(isset($_POST['ok'])!=''){
	...
	$tco1 = str_replace(",","",$tco);
		...
		if(mysqli_query($conn,"update kgpricetb set cprice='{$_POST["cprice"]}', sprice='{$_POST["sprice"]}' where prodid='PA1'")){
			...
			<div class="banner-bg"> 
					...
					<div class="banner">
						...
						<?php include("nav.php");?>
								...
								<h2><a href="">PRICE PER KILOGRAM</a></h2>	
							...
							<div class="banner-middle">
									...
									<div class="banner-bottom-left">
										...
										<div class="banner-bottom-left-grids">
                                            <div class="col-md-4 banner-left-grid fullwidth-left-grid login-right wow fadeInLeft" data-wow-delay="0.4s">
												<h3>Set Price of Kilogram</h3><p><?php echo $msg?></p>
                                                ...
                                                <div>
													...
													<input type="text" name="sprice" id="sprice" onKeyUp="javascript:this.value=Comma(this.value);" value="<?php echo $gettypes['cprice']?>"> 
												</div>
                                                <div>
													<span>Selling Price</span>
													<input type="text" name="sprice" id="sprice" onKeyUp="javascript:this.value=Comma(this.value);" value="<?php echo $gettypes['sprice']?>"> 
												</div>
                               ...
                               <thead>
                                    <tr style="font-size:12px;">
                                        ...
                                        <th colspan="6">No Details Founds</th>
                                    </tr>
                                </thead>
                                <tbody>
