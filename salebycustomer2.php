...
<html>
                            ...
                            <div class="banner-grids">
                                ...
                                <div class="ban-top">
                                    ...
                                    <div class="col-md-12 bann-right">
                                        <h2><a href="">CUSTOMER PURCHASE REPORT</a></h2>	
  ...
  and custid = '$_POST[dealer]' and status='active' group by prodid,custid order by dot asc;");
                                                        ...
                                                        $cname = mysqli_fetch_array(mysqli_query($conn, "select * from customers where custid='$_POST[dealer]'"));
                                                        ?>
                                                        <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example1">
                                                            <thead>
                                                                <tr style="font-size:13px;">
                                                                    <th colspan="6" style="text-align:center;"><?php echo $cname['custname'] ?> Purchase Report from <?php echo date_format(date_create($_POST['sdate']), "d/m/Y") ?> to <?php echo date_format(date_create($_POST['enddate']), "d/m/Y") ?></th>
                                                                </tr>
                                                                <tr style="font-size:13px">
                                                                    <th>Date</th>
                                                                    <th>Product</th>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                while ($rs = mysqli_fetch_array($q)) {
                                                                    ...
                                                                    $gc = mysqli_fetch_array(mysqli_query($conn, "select custid,custname from customers where custid='$rs[custid]'"));
                                                                    //$up = $up + $rs['unitprice'];
                                                                    $tp = $tp + $rs['totp'];
                                                                    ?>            
                                                                    <tr class="" style="font-size:13px;">
                                                                        ...
                                                                        <td><?php echo $rs['totq'] ?></td>
                                                                        <td><?php echo number_format($rs['totp'], 2) ?></td>
                                                                ...
                                                                <tr class="" style="font-size:13px; font-weight:bold">
                                                                    <td><?php if ($dd == 0) { ?><a style="color:#F00" href="addpayment.php?amt=<?php echo $tp ?>&datee=<?php echo $_POST['sdate'] ?>&cust=<?php echo $_POST['dealer'] ?>">Add Payment</a><?php } ?></td>
                                                                    <td>Totals:</td>
                                                                    <td>&nbsp;</td>
