                                        ...
                                        <div class="banner-bottom-left">
                                            ...
                                            <div class="banner-bottom-left-grids">
                                                <div class="col-md-12 banner-left-grid fullwidth-left-grid login-right wow fadeInLeft" data-wow-delay="0.4s">
                                                    <h3>All Products</h3><p>&nbsp;</p>

                                                    <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                                                        <thead>
                                                            <tr style="font-size:12px">

                                                                <th colspan="6" style="text-align:center;">All Products</th>
                                                            </tr>
                                                            <tr style="font-size:12px">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            while ($rs = mysqli_fetch_array($q)) {
                                                                ...
                                                                <tr class="" style="font-size:12px;">
                                                                    ...
                                                                    <td><?php echo $rs['prodname'] ?></td>
                                                                    <td><?php echo $rs['totqty'] . "(" . $rs['unit'] . ")" ?></td>
                                                                    <td><?php echo $rs['tco'] ?></td>
                                                                    <td><?php echo $rs['onhand'] ?></td>
                                                                    <td><?php echo $rs['asat'] ?></td>
                                                                    <td><a href="products.php?id=<?php echo $rs['prodid'] ?>">Edit</a>&nbsp;&nbsp;
                                                                        <a href="products.php?del=<?php echo $rs['prodid'] ?>">Delete</a></td>
                                                                </tr>
                                                                <?php
                                                            }
                                                            ?>        
                                                            <tr class="" style="font-size:12px;">
                                                                ...
                                                                <td></td>
                                                                <td></td>
                                                                <td><a href="javascript:printtab();">Print</a></td>
                                                            </tr>            
                                                        </tbody>
                                                    </table>
