...
<div class="container">
	<div class="bg-banner">
		...
		<table width="100%" class="table table-striped table-bordered table-hover">
					...
					$b=0; 
					$q = mysqli_query($conn,"select * from creditrepayment where dot>='$_POST[sdate]' and dot<='$_POST[enddate]' order by dot asc");
					while($rs = mysqli_fetch_array($q)){
						$b++;
						$rd = mysqli_fetch_array(mysqli_query($conn,"select * from creditor where sn='$rs[debtid]'"));
        ...
        <tr class="" style="font-size:10px;">
                                      <td><?php echo $rs['dot']?></td>
                                        <td><?php echo number_format($rd['amt'],2)?></td>
                                        <td><?php echo number_format($rs['amtpaid'],2)?></td>
                                        <td><?php echo number_format($rd['amtbal'],2)?></td>
                                        <td><?php echo $rd['purpose']?></td>
                                        <td><?php echo $rs['payer']?></td>
                                        <td><?php echo $ra['vendname']?></td>
                                       <td><a href="repaycredit.php?id=<?php echo $rs['creditid']?>">Edit</a>&nbsp;&nbsp;
